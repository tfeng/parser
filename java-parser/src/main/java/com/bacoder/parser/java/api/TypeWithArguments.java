...
public class TypeWithArguments extends JavaNode implements InstantiableType {
  ...
  protected void visitChildren(Visitors visitors) {
    for (IdentifierWithTypeArguments identifierWithTypeArguments : identifiersWithTypeArguments) {
      identifierWithTypeArguments.visit(visitors);
    }
  }
}
